...
const navItems = [{ to: '/staff/scanner', icon: QrCode, label: 'Scanner' }];
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      >
        <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100">
          <Logo subtitle="Staff Portal" size={56} to="/staff/scanner" />
          <button
      ...
      <div className="flex-1 lg:ml-[260px] flex flex-col min-h-screen">
        <header className="sticky top-0 z-10 bg-white border-b border-gray-100 h-[72px] px-4 md:px-6 flex items-center gap-4">
          ...
          <div className="min-w-0">
            <p className="text-xs text-gray-400 hidden sm:block">Staff / Scanner</p>
            <h1 className="text-base font-bold text-slate-900 truncate">QR Scanner</h1>
          </div>
