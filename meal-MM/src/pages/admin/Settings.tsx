  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="card flex items-center gap-4">
        <div className="w-14 h-14 avatar-gradient rounded-2xl flex items-center justify-center flex-shrink-0">
        ...
        <div>
          ...
          <span className="badge-info mt-1">Administrator</span>
        </div>
      </div>
          ...
          {[
            ...
            <div key={field.key}>
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => setShowPw({ ...showPw, [field.showKey]: !(showPw as any)[field.showKey] })}
                  aria-label={(showPw as any)[field.showKey] ? 'Hide password' : 'Show password'}
      ...
      <div className="card">
        <div className="mb-4">
          <Logo subtitle="Hostel Mess Management System" size={48} />
        </div>
        ...
        <div className="space-y-2">
          {['Terms & Conditions', 'Privacy Policy', 'Help & Support'].map(item => (
            <div key={item} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-xl cursor-pointer transition-colors duration-150">
